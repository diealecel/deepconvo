...
if __name__ == '__main__':
    ...
    # Set up for training.
    train_batch_generator = generate_batch(DATASET_PATH, 'train', BATCH_SZ, NUM_FRAMES_PER_TENSOR, TENSOR_TYPE)
    ...
    # Set up for testing.
    test_batch_generator = generate_batch(DATASET_PATH, 'val', BATCH_SZ, NUM_FRAMES_PER_TENSOR, TENSOR_TYPE)
